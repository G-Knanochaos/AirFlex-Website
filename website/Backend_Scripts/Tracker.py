...
def scatter(hours, temps):
    ...
    plt.savefig(f"Temperature_graph.png")


# ---[MAIN]---

def main():
    plot = plot_graph(dates=[['2019-08-03', '2020-08-03', '2021-08-03'], ['2019-08-03', '2020-08-03', '2022-08-03']],
               y_vals=[['8', '7', '5'], ['65', '66', '67']], y_names=['Hours', 'Temperature'],
               colors=['#00A36C', '#088F8F'],
               graph_name='AC Hours and Temperature')
    pie_chart([8, 8, 9, 8, 9, 9, 8, 9], [1, 1, 2, 3, 1, 2, 1, 1], 'AC vs Fan Costs')
    scatter([2, 4, 7, 5, 8, 4], [65, 54, 76, 65, 67, 63])
